...
class ManageUser
{
	...
	{	
		...
		switch($run)
		{
			case 0:// NO ID, ADD USERNAME (not password)
				$insert_stmt = $db_write->stmt_init();
			...
			case 1: // HAS ID, UPDATE USERNAME (not password)
				$update_stmt = $db_write->stmt_init();
			...
			case 2: // NO ID, ADD USERNAME AND PASSWORD
				$insert_stmt = $db_write->stmt_init();
			...
			case 3: // HAS USERID, UPDATE USERNAME AND PASSWORD
				$update_stmt = $db_write->stmt_init();
