...
<head>
	...
	<style media="all" type="text/css">@import "{# theme_path #}css/admin_common.css";</style>

<script type="text/javascript" src="file:///Users/tedivm/Documents/Admin/javascript/jquery-1.2.6.js"></script>
<script type="text/javascript" src="file:///Users/tedivm/Documents/Admin/javascript/jquery-ui-1.6b.js"></script>
...
//tab click	
	$('#top-navigation li').click(function (event) {
		...
		if( target.is("li") && !target.hasClass("active") ) 
		{
			...
			$('#center-column').hide("slide", {direction: "down"}, 650).show("slide", {direction: "down"}, 650);
...
<div id="main">
	<div id="header">
		...
		<ul id="top-navigation">
			<li class="active"><span><span><a href="#">Homepage</span></span></a></li>
			<li><span><span><a href="#">Users</span></span></a></li>
...
<div>
	<a href="#" class="link">123456789 1234567</a>	
			<h3>Header</h3>
			<ul class="nav">
