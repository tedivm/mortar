...
class BentoCMSActionAddPage extends PackageAction
{
	...
	public function logic()
	{
		...
		if($form->checkSubmit())
		{
			...
			$module = new ModuleInfo($inputHandler['module']);
			if($module->checkAuth('Add'))
			{
				...
				$cms->property(array('module' => $inputHandler['module'], 'name' => $inputHandler['name'], 'keywords' => $inputHandler['keywords'], 'description' => $inputHandler['description']));
				$cms->save();
