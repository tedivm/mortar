...
class TesseraCoreActionModelPostComment extends ModelActionLocationBasedEdit
{
	...
	public function logic()
	{
		...
		if(!TesseraCoreComments::canCommentModelType($this->model->getType())) {
	...
	protected function getForm()
	{
		...
		return new TesseraCorePostCommentForm('comment-form', $discussion, $name);
	}
